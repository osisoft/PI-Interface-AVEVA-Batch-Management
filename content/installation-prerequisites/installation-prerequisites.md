...
Minimum required versions of PI Server software: PI Server 2015 and PI AF 2010 R3 (2.4).
...
If the data source is Microsoft SQL Server, you must install the Microsoft SQL Native Client on the interface node. You can download the client from the MSDN web site.
